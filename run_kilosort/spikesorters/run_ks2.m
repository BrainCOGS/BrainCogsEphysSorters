function run_ks2(rootZ, rootH, dir_pattern, channel_map_file)
...
try
    ...
    if nargin <= 3, channel_map_file = '/tigress/alvaros/run_kilosort/spikesorters/kilosort2/configFiles/neuropixPhase3B1_kilosortChanMap.mat'; end
    %if nargin <3, channel_map_file = '/tigress/ms81/spikesorters/kilosort3/configFiles/chanMap_npx2.mat'; end
